...
SAVE_DIR="$WINE_PREFIX/drive_c/users/$SERVER_USER/AppData/LocalLow/Astrolabe Interactive/Aloft/Data02/Saves"
...
if [ "\$MODE" = "create" ]; then
    ...
    WINEDEBUG=-all WINEPREFIX=$WINE_PREFIX wine Aloft.exe -batchmode -nographics -server create#\$MAP_NAME#\ islandcount#\$CREATIVE# log#ERROR# disablevideo#true# > "\$log_file" 2>&1
